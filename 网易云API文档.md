[]: 
API:https://api-enhanced-nine-cyan.vercel.app/
## [接口文档](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=接口文档)

### [调用前须知](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=调用前须知)

AI 生成的图,仅供娱乐()

![ai generated](https://api-enhanced-nine-cyan.vercel.app/docs/aigen.png)
...
### [登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=登录)
...
#### [1. 手机登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_1-手机登录)
...
#### [2. 邮箱登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_2-邮箱登录)
...
#### [3. 二维码登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_3-二维码登录)

说明: 二维码登录涉及到 3 个接口,调用务必带上时间戳,防止缓存

##### [1. 二维码 key 生成接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_1-二维码-key-生成接口)

说明: 调用此接口可生成一个 key

**接口地址 :** `/login/qr/key`

##### [2. 二维码生成接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_2-二维码生成接口)
...
##### [3. 二维码检测扫码状态接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_3-二维码检测扫码状态接口)
...
#### [3. 游客登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_3-游客登录)

说明 : 直接调用此接口, 可获取游客 cookie,如果遇到其他接口未登录状态报 400 状态码需要验证的错误,可使用此接口获取游客 cookie 避免报错

**接口地址 :** `/register/anonimous`

#### [注意](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=注意)

调用登录接口的速度比调用其他接口慢 , 因为登录过程调用了加密算法

### [刷新登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=刷新登录)

说明 : 调用此接口 , 可刷新登录状态,返回内容包含新的 cookie(不支持刷新二维码登录的 cookie)

**调用例子 :** `/login/refresh`

### [发送验证码](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送验证码)
...
### [新版发送验证码](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=新版发送验证码)
...
### [验证验证码](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=验证验证码)
...
### [注册(修改密码)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=注册修改密码)
...
### [检测手机号码是否已注册](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=检测手机号码是否已注册)
...
### [初始化昵称](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=初始化昵称)
...
### [重复昵称检测](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=重复昵称检测)
...
### [更换绑定手机](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更换绑定手机)
...
### [退出登录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=退出登录)

说明 : 调用此接口 , 可退出登录

**调用例子 :** `/logout`

### [登录状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=登录状态)

说明 : 调用此接口,可获取登录状态

**接口地址 :** `/login/status`

### [获取用户详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户详情)
...
### [获取账号信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取账号信息)
...
### [获取用户信息 , 歌单，收藏，mv, dj 数量](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户信息-歌单，收藏，mv-dj-数量)
...
### [获取用户等级信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户等级信息)
...
### [获取用户绑定信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户绑定信息)
...
### [用户绑定手机](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户绑定手机)
...
### [更新用户信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更新用户信息)
...
### [更新头像](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更新头像)
...
### [私信和通知接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=私信和通知接口)
...
### [国家编码列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=国家编码列表)

说明 : 调用此接口,可获取国家编码列表

**接口地址 :** `/countries/code/list`

### [获取用户歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户歌单)
...
### [更新歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更新歌单)
...
### [更新歌单描述](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更新歌单描述)
...
### [更新歌单名](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更新歌单名)
...
### [更新歌单标签](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=更新歌单标签)
...
### [歌单封面上传](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单封面上传)
...
### [调整歌单顺序](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=调整歌单顺序)
...
### [调整歌曲顺序](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=调整歌曲顺序)
...
### [获取用户历史评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户历史评论)
...
### [获取用户电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户电台)
...
### [获取用户关注列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户关注列表)
...
### [获取用户粉丝列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户粉丝列表)
...
### [获取用户动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户动态)
...
### [获取当前登录用户的全部可枚举动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取当前登录用户的全部可枚举动态)
...
### [修改动态可见权限](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=修改动态可见权限)
...
### [转发用户动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=转发用户动态)
...
### [删除用户动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=删除用户动态)
...
### [分享文本、歌曲、歌单、mv、电台、电台节目到动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=分享文本、歌曲、歌单、mv、电台、电台节目到动态)
...
### [获取动态评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取动态评论)
...
### [关注/取消关注用户](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=关注取消关注用户)
...
### [获取用户播放记录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取用户播放记录)
...
### [获取热门话题](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取热门话题)
...
### [获取话题详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取话题详情)
...
### [获取话题详情热门动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取话题详情热门动态)
...
### [云村热评(官方下架,暂不能用)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云村热评官方下架暂不能用)
...
### [心动模式/智能播放](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=心动模式智能播放)
...
### [获取动态列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取动态列表)
...
### [歌手分类列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手分类列表)
...
### [收藏/取消收藏歌手](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏取消收藏歌手)
...
### [歌手热门 50 首歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手热门-50-首歌曲)
...
### [歌手全部歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手全部歌曲)
...
### [收藏的歌手列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏的歌手列表)
...
### [收藏的专栏](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏的专栏)
...
### [收藏视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏视频)
...
### [收藏/取消收藏 MV](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏取消收藏-mv)
...
### [收藏的 MV 列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏的-mv-列表)
...
### [歌单分类](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单分类)
...
### [热门歌单分类](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=热门歌单分类)
...
### [歌单 ( 网友精选碟 )](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单-网友精选碟-)
...
### [精品歌单标签列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=精品歌单标签列表)
...
### [获取精品歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取精品歌单)
...
### [相关歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=相关歌单)

说明: 请替换为[相关歌单推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=相关歌单推荐)接口; 本接口通过 html 抓取内容, 现已无法抓取歌单
...
### [获取歌单详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌单详情)
...
### [获取歌单所有歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌单所有歌曲)
...
### [歌单详情动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单详情动态)
...
### [歌单更新播放量](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单更新播放量)
...
### [获取音乐 url](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取音乐-url)
...
### [获取音乐 url - 新版](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取音乐-url-新版)
...
### [302到音乐 url - 新版](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=_302到音乐-url-新版)
...
### [音乐是否可用](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐是否可用)
...
### [直接获取灰色歌曲链接](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=直接获取灰色歌曲链接)
...
### [搜索](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=搜索)
...
### [默认搜索关键词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=默认搜索关键词)

说明 : 调用此接口 , 可获取默认搜索关键词

**接口地址 :** `/search/default`

### [热搜列表(简略)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=热搜列表简略)
...
### [热搜列表(详细)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=热搜列表详细)
...
### [搜索建议](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=搜索建议)
...
### [搜索多重匹配](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=搜索多重匹配)
...
### [新建歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=新建歌单)
...
### [删除歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=删除歌单)
...
### [收藏/取消收藏歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏取消收藏歌单)
...
### [歌单收藏者](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单收藏者)

说明 : 调用此接口 , 传入歌单 id 可获取歌单的所有收藏者 **必选参数 :**
...
### [对歌单添加或删除歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=对歌单添加或删除歌曲)
...
### [收藏视频到视频歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏视频到视频歌单)
...
### [删除视频歌单里的视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=删除视频歌单里的视频)
...
### [最近播放的视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放的视频)
...
### [获取歌词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌词)
...
### [获取逐字歌词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取逐字歌词)
...
### [新歌速递](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=新歌速递)
...
### [首页-发现](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=首页-发现)
...
### [首页-发现-圆形图标入口列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=首页-发现-圆形图标入口列表)

说明 : 调用此接口 , 可获取 APP 首页圆形图标入口列表

**接口地址 :** `/homepage/dragon/ball`

### [歌曲评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲评论)
...
### [楼层评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=楼层评论)
...
### [专辑评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=专辑评论)
...
### [歌单评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单评论)
...
### [mv 评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=mv-评论)
...
### [电台节目评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台节目评论)
...
### [视频评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=视频评论)
...
### [评论统计数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=评论统计数据)
...
### [热门评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=热门评论)
...
### [新版评论接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=新版评论接口)
...
### [给评论点赞](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=给评论点赞)
...
### [抱一抱评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=抱一抱评论)
...
### [评论抱一抱列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=评论抱一抱列表)
...
### [发送/删除评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送删除评论)
...
### [banner](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=banner)
...
### [资源点赞( MV,电台,视频)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=资源点赞-mv电台视频)
...
### [获取点赞过的视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取点赞过的视频)
...
### [获取歌曲详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌曲详情)
...
### [获取专辑内容](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取专辑内容)
...
### [专辑动态信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=专辑动态信息)
...
### [收藏/取消收藏专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=收藏取消收藏专辑)
...
### [获取已收藏专辑列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取已收藏专辑列表)
...
### [获取歌手单曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌手单曲)
...
### [获取歌手 mv](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌手-mv)
...
### [获取歌手专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌手专辑)
...
### [获取歌手描述](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌手描述)
...
### [获取歌手详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌手详情)
...
### [获取相似歌手](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取相似歌手)
...
### [获取相似歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取相似歌单)
...
### [相似 mv](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=相似-mv)
...
### [获取相似音乐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取相似音乐)
...
### [获取最近 5 个听了这首歌的用户](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取最近-5-个听了这首歌的用户)
...
### [获取每日推荐歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取每日推荐歌单)
...
### [获取每日推荐歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取每日推荐歌曲)
...
### [每日推荐歌曲-不感兴趣](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=每日推荐歌曲-不感兴趣)
...
### [获取历史日推可用日期列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取历史日推可用日期列表)
...
### [获取历史日推详情数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取历史日推详情数据)
...
### [私人 FM](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=私人-fm)
...
### [签到](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=签到)
...
### [乐签信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=乐签信息)

说明 : 调用此接口, 可获取乐签信息

**接口地址 :** `/sign/happy/info`

### [喜欢音乐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=喜欢音乐)
...
### [喜欢音乐列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=喜欢音乐列表)
...
### [垃圾桶](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=垃圾桶)
...
### [新碟上架](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=新碟上架)
...
### [全部新碟](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=全部新碟)
...
### [最新专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最新专辑)
...
### [听歌打卡](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌打卡)
...
#### [听歌打卡 V2 (NCBL 加密版)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌打卡-v2-ncbl-加密版)
...
### [提交歌曲播放状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=提交歌曲播放状态)
...
### [热门歌手](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=热门歌手)
...
### [全部 mv](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=全部-mv)

说明 : 调用此接口 , 可获取全部 mv

**可选参数 :** `area`: 地区,可选值为全部,内地,港台,欧美,日本,韩国,不填则为全部 `type`: 类型,可选值为全部,官方版,原生,现场版,网易出品,不填则为全部
...
### [最新 mv](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最新-mv)
...
### [网易出品 mv](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=网易出品-mv)
...
### [推荐 mv](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=推荐-mv)
...
### [推荐歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=推荐歌单)
...
### [推荐新音乐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=推荐新音乐)
...
### [推荐电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=推荐电台)
...
### [推荐节目](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=推荐节目)
...
### [独家放送(入口列表)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=独家放送入口列表)
...
### [独家放送列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=独家放送列表)
...
### [mv 排行](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=mv-排行)
...
### [获取 mv 数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取-mv-数据)
...
### [获取 mv 点赞转发评论数数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取-mv-点赞转发评论数数据)
...
### [mv 地址](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=mv-地址)
...
### [获取视频标签列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取视频标签列表)
...
### [获取视频分类列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取视频分类列表)
...
### [获取视频标签/分类下的视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取视频标签分类下的视频)
...
### [获取全部视频列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取全部视频列表)
...
### [获取推荐视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取推荐视频)
...
### [相关视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=相关视频)
...
### [视频详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=视频详情)
...
### [获取视频点赞转发评论数数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取视频点赞转发评论数数据)
...
### [获取视频播放地址](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取视频播放地址)
...
### [所有榜单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=所有榜单)

说明 : 调用此接口,可获取所有榜单 **接口地址 :** `/toplist`

**调用例子 :** `/toplist`

### [排行榜详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=排行榜详情)

说明: 请使用[歌单详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌单详情)接口,传入排行榜 id 获取排行榜详情数据(排行榜也是歌单的一种)
...
### [所有榜单内容摘要](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=所有榜单内容摘要)
...
### [歌手榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手榜)
...
### [云盘](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云盘)
...
### [云盘数据详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云盘数据详情)
...
### [云盘歌曲删除](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云盘歌曲删除)
...
### [云盘上传](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云盘上传)
...
#### [上传模式说明](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=上传模式说明)
...
#### [客户端直传相关接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=客户端直传相关接口)
...
#### [客户端直传流程](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=客户端直传流程)
...
### [云盘歌曲信息匹配纠正](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云盘歌曲信息匹配纠正)
...
### [获取云盘歌词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取云盘歌词)
...
### [电台 banner](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-banner)
...
### [电台个性推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台个性推荐)
...
### [电台订阅者列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台订阅者列表)
...
### [用户电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户电台)
...
### [热门电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=热门电台)
...
### [电台 - 节目榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-节目榜)
...
### [电台 - 付费精品](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-付费精品)
...
### [电台 - 24 小时节目榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-24-小时节目榜)
...
### [电台 - 24 小时主播榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-24-小时主播榜)
...
### [电台 - 主播新人榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-主播新人榜)
...
### [电台 - 最热主播榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-最热主播榜)
...
### [电台 - 新晋电台榜/热门电台榜](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-新晋电台榜热门电台榜)
...
### [电台 - 类别热门电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-类别热门电台)
...
### [电台 - 推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-推荐)
...
### [电台 - 分类](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-分类)
...
### [电台 - 分类推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-分类推荐)
...
### [电台 - 订阅](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-订阅)
...
### [电台的订阅列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台的订阅列表)
...
### [电台 - 付费精选](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-付费精选)
...
### [电台 - 非热门类型](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-非热门类型)
...
### [电台 - 推荐类型](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-推荐类型)
...
### [电台 - 今日优选](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-今日优选)
...
### [电台 - 详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-详情)
...
### [电台 - 节目](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-节目)
...
### [电台 - 节目详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台-节目详情)
...
### [通知 - 私信](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=通知-私信)
...
### [发送私信](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送私信)
...
### [发送私信(带歌曲)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送私信带歌曲)
...
### [发送私信(带专辑)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送私信带专辑)
...
### [发送私信(带歌单)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送私信带歌单)
...
### [最近联系人](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近联系人)
...
### [私信内容](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=私信内容)
...
### [通知 - 评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=通知-评论)
...
### [通知 - @我](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=通知-我)
...
### [通知 - 通知](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=通知-通知)
...
### [设置](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=设置)
...
### [数字专辑-新碟上架](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=数字专辑-新碟上架)
...
```
offset` : 偏移数量，用于分页 , 如 :( 页数 -1)*30, 其中 30 为 limit 的值 , 默认为 0 **接口地址 :** `/album/list
```

**调用例子 :** `/album/list?limit=10`

### [数字专辑&数字单曲-榜单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=数字专辑amp数字单曲-榜单)
...
### [数字专辑-语种风格馆](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=数字专辑-语种风格馆)
...
### [数字专辑详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=数字专辑详情)
...
### [我的数字专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=我的数字专辑)
...
### [购买数字专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=购买数字专辑)
...
### [音乐日历](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐日历)
...
### [云贝](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝)
...
### [云贝今日签到信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝今日签到信息)
...
### [云贝签到](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝签到)
...
### [云贝账户信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝账户信息)
...
### [云贝所有任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝所有任务)
...
### [云贝 todo 任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝-todo-任务)
...
### [云贝完成任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝完成任务)
...
### [云贝广告任务 - 今日任务状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝广告任务-今日任务状态)
...
### [云贝广告任务 - 获取推荐歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝广告任务-获取推荐歌曲)
...
### [云贝广告任务 - 完成任务领取云贝](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝广告任务-完成任务领取云贝)
...
### [云贝收入](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝收入)
...
### [云贝支出](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝支出)
...
```
offset`: 偏移数量 , 用于分页 , 如 :( 评论页数 -1)*10, 其中 10 为 limit 的值 **接口地址 :** `/yunbei/tasks/expense
```

**调用例子 :** `/yunbei/tasks/expense?limit=1`

### [关注歌手新歌](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=关注歌手新歌)
...
### [关注歌手最近新歌 - 播放全部](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=关注歌手最近新歌-播放全部)
...
### [关注歌手新作品（歌曲/MV）](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=关注歌手新作品（歌曲mv）)
...
### [关注歌手新 MV](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=关注歌手新-mv)
...
### [一起听相关](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=一起听相关)
...
### [batch 批量请求接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=batch-批量请求接口)
...
### [云贝推歌](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝推歌)
...
### [云贝推歌历史记录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云贝推歌历史记录)
...
### [已购单曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=已购单曲)
...
### [获取 mlog 播放地址](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取-mlog-播放地址)
...
### [将 mlog id 转为视频 id](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=将-mlog-id-转为视频-id)
...
### [vip 成长值](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=vip-成长值)
...
### [vip 成长值获取记录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=vip-成长值获取记录)
...
### [vip 任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=vip-任务)
...
### [领取 vip 成长值](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=领取-vip-成长值)
...
### [一键领取所有 vip 成长值](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=一键领取所有-vip-成长值)
...
### [歌手粉丝](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手粉丝)
...
### [歌手粉丝数量](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手粉丝数量)
...
### [数字专辑详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=数字专辑详情-1)
...
### [数字专辑销量](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=数字专辑销量)
...
### [音乐人数据概况](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐人数据概况)
...
### [音乐人播放趋势](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐人播放趋势)
...
### [音乐人任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐人任务)
...
### [音乐人任务(新)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐人任务新)
...
### [音乐人黑胶会员任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐人黑胶会员任务)
...
### [账号云豆数](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=账号云豆数)
...
### [领取云豆](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=领取云豆)
...
### [获取 VIP 信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取-vip-信息)
...
### [获取 VIP 信息(app 端)](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取-vip-信息app-端)
...
### [音乐人签到](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐人签到)
...
### [歌曲相关视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲相关视频)
...
### [公开隐私歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=公开隐私歌单)
...
### [获取客户端歌曲下载 url](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取客户端歌曲下载-url)
...
### [获取歌手视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取歌手视频)
...
### [最近播放-歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放-歌曲)
...
### [最近播放-视频](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放-视频)
...
### [最近播放-声音](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放-声音)
...
### [最近播放-歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放-歌单)
...
### [最近播放-专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放-专辑)
...
### [最近播放-播客](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近播放-播客)
...
### [签到进度](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=签到进度)
...
### [内部版本接口](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=内部版本接口)
...
### [黑胶时光机](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=黑胶时光机)
...
### [音乐百科 - 简要信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=音乐百科-简要信息)
...
### [乐谱列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=乐谱列表)
...
### [乐谱内容](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=乐谱内容)
...
### [曲风列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风列表)
...
### [曲风偏好](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风偏好)
...
### [曲风详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风详情)
...
### [曲风-歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风-歌曲)
...
### [曲风-专辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风-专辑)
...
### [曲风-歌单](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风-歌单)
...
### [曲风-歌手](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风-歌手)
...
### [云村星评馆 - 简要评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云村星评馆-简要评论)

说明: 调用此接口可以获取首页推荐的星评馆评论信息

**接口地址:** `/starpick/comments/summary`

### [私人 DJ](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=私人-dj)
...
### [回忆坐标](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=回忆坐标)
...
### [播客列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客列表)
...
### [播客声音列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客声音列表)
...
### [播客声音搜索](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客声音搜索)
...
### [播客声音详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客声音详情)
...
### [播客声音排序](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客声音排序)
...
### [播客列表详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客列表详情)
...
### [播客删除](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客删除)
...
### [播客上传声音](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=播客上传声音)

说明: 登录后调用此接口,使用`'Content-Type': 'multipart/form-data'`上传声音文件 formData(name 为`songFile`),可通过 formData(name 为`imgFile`)同时上传声音封面。例子在 `/public/voice_upload.html` 访问地址: [/voice_upload.html](https://api-enhanced-nine-cyan.vercel.app/voice_upload.html)
...
### [电台排行榜获取](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=电台排行榜获取)
...
### [获取声音歌词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取声音歌词)
...
### [验证接口-二维码生成](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=验证接口-二维码生成)
...
### [验证接口-二维码检测](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=验证接口-二维码检测)
...
### [听歌识曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌识曲)
...
### [根据 nickname 获取 userid](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=根据-nickname-获取-userid)
...
### [专辑简要百科信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=专辑简要百科信息)
...
### [歌曲简要百科信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲简要百科信息)
...
### [歌手简要百科信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手简要百科信息)
...
### [mv 简要百科信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=mv-简要百科信息)
...
### [搜索歌手](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=搜索歌手)
...
### [用户贡献内容](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户贡献内容)
...
### [用户贡献条目、积分、云贝数量](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户贡献条目、积分、云贝数量)
...
### [年度听歌报告](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=年度听歌报告)
...
### [本地歌曲文件匹配网易云歌曲信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=本地歌曲文件匹配网易云歌曲信息)
...
### [歌曲音质详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲音质详情)
...
### [歌曲红心数量](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲红心数量)
...
### [私人 FM 模式选择](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=私人-fm-模式选择)
...
### [获取专辑歌曲的音质](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取专辑歌曲的音质)
...
### [歌手详情动态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌手详情动态)
...
### [最近听歌列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=最近听歌列表)

说明 : 调用后可获取最近听歌列表

**接口地址 :** `/recent/listen/list`

### [云盘导入歌曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云盘导入歌曲)
...
### [获取客户端歌曲下载链接 - 新版](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取客户端歌曲下载链接-新版)
...
### [当前账号关注的用户/歌手](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=当前账号关注的用户歌手)
...
### [会员下载歌曲记录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=会员下载歌曲记录)
...
### [会员本月下载歌曲记录](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=会员本月下载歌曲记录)
...
### [已购买单曲](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=已购买单曲)
...
### [歌曲是否喜爱](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲是否喜爱)
...
### [用户是否互相关注](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户是否互相关注)
...
### [歌曲动态封面](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲动态封面)
...
### [用户徽章](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户徽章)
...
### [用户状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户状态)
...
### [用户状态 - 支持设置的状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户状态-支持设置的状态)

说明 : 登录后调用此接口, 获取支持设置的状态

**接口地址 :** `/user/social/status/support`

### [用户状态 - 相同状态的用户](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户状态-相同状态的用户)

说明 : 登录后调用此接口, 获取相同状态的用户

**接口地址 :** `/user/social/status/rcmd`

### [用户状态 - 编辑](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户状态-编辑)

说明 : 登录后调用此接口, 编辑当前用户状态， 所需参数可在接口`/user/social/status/support`获取

**接口地址 :** `/user/social/status/edit`

### [听歌足迹 - 年度听歌足迹](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌足迹-年度听歌足迹)

说明 : 登录后调用此接口, 获取年度听歌足迹

**接口地址 :** `/listen/data/year/report`

### [听歌足迹 - 今日收听](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌足迹-今日收听)

说明 : 登录后调用此接口, 获取今日收听

**接口地址 :** `/listen/data/today/song`

### [听歌足迹 - 歌曲播放排行](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌足迹-歌曲播放排行)
...
`endTime` : 周: 每周周六 0 点的时间戳 月: 每月最后一天 0 点的时间戳 不填就是本周/月的

**接口地址 :** `/listen/data/song/play/rank`

**调用例子 :** `/listen/data/song/play/rank?type=month`

### [听歌足迹 - 总收听时长](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌足迹-总收听时长)

说明 : 登录后调用此接口, 获取总收听时长; 相关接口可能需要 vip 权限

**接口地址 :** `/listen/data/total`

### [听歌足迹 - 本周/本月收听时长](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌足迹-本周本月收听时长)
...
### [听歌足迹 - 周/月/年收听报告](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=听歌足迹-周月年收听报告)
...
### [歌单导入 - 元数据/文字/链接导入](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单导入-元数据文字链接导入)
...
### [歌单导入 - 任务状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌单导入-任务状态)
...
### [副歌时间](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=副歌时间)
...
### [相关歌单推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=相关歌单推荐)
...
### [歌词摘录 - 歌词摘录信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌词摘录-歌词摘录信息)
...
### [歌词摘录 - 我的歌词本](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌词摘录-我的歌词本)
...
### [歌词摘录 - 添加/修改摘录歌词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌词摘录-添加修改摘录歌词)
...
### [歌词摘录 - 删除摘录歌词](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌词摘录-删除摘录歌词)
...
### [广播电台 - 分类/地区信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=广播电台-分类地区信息)
...
### [广播电台 - 我的收藏](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=广播电台-我的收藏)
...
### [广播电台 - 电台信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=广播电台-电台信息)
...
### [广播电台 - 全部电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=广播电台-全部电台)
...
### [黑胶乐签打卡](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=黑胶乐签打卡)
...
### [黑胶乐签未来打卡信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=黑胶乐签未来打卡信息)
...
### [广播电台 - 收藏/取消收藏电台](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=广播电台-收藏取消收藏电台)
...
### [用户的创建歌单列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户的创建歌单列表)
...
### [用户的收藏歌单列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=用户的收藏歌单列表)
...
### [搜索建议 - PC端](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=搜索建议-pc端)
...
### [喜欢歌曲 - 新版](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=喜欢歌曲-新版)
...
### [我创建的播客声音](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=我创建的播客声音)
...
### [DIFM电台 - 分类](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=difm电台-分类)
...
### [DIFM电台 - 收藏列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=difm电台-收藏列表)
...
### [DIFM电台 - 收藏频道](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=difm电台-收藏频道)
...
### [DIFM电台 - 取消收藏频道](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=difm电台-取消收藏频道)
...
### [DIFM电台 - 播放列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=difm电台-播放列表)
...
### [助眠解压 - 特定时间场景下的推荐资源](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=助眠解压-特定时间场景下的推荐资源)
...
### [助眠解压 - 标签列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=助眠解压-标签列表)
...
### [助眠解压 - 获取标签下资源列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=助眠解压-获取标签下资源列表)
...
### [助眠解压 - 查看同类推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=助眠解压-查看同类推荐)
...
### [助眠解压 - 收藏列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=助眠解压-收藏列表)
...
### [助眠解压 - 收藏](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=助眠解压-收藏)
...
### [跑步漫游](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=跑步漫游)
...
### [歌曲创作者信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=歌曲创作者信息)
...
### [灰色歌曲的其他版本推荐](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=灰色歌曲的其他版本推荐)
...
### [举报评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=举报评论)
...
### [多级行政区划数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=多级行政区划数据)
...
### [指定维度音乐排行榜详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=指定维度音乐排行榜详情)
...
`targetId`: 目标 id,城市榜如 `110000`,城市风格榜如 北京华语流行榜 `110000_1020`。城市风格榜格式通常为 `城市 id_曲风 id`,其中曲风 id 可通过[曲风列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=曲风列表)接口 `/style/list` 获取。城市榜的城市列表可通过[多级行政区划数据](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=多级行政区划数据)接口传入 `bizCode=chart` 获取；城市风格榜的城市列表可通过该接口传空 `bizCode` 获取
...
### [指定维度音乐排行榜列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=指定维度音乐排行榜列表)
...
### [会员任务 - 新版](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=会员任务-新版)
...
### [黑胶乐签详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=黑胶乐签详情)
...
### [黑胶乐签历史](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=黑胶乐签历史)
...
### [直接获取云盘歌曲下载链接](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=直接获取云盘歌曲下载链接)
...
### [获取广告](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取广告)
...
### [看广告领取权益（免费听歌时长 / 云贝等）](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=看广告领取权益（免费听歌时长-云贝等）)
...
### [获取免费听时长状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取免费听时长状态)
...
### [云小编 - 获取用户详情](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-获取用户详情)
...
### [云小编 - 每日签到](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-每日签到)
...
### [云小编 - 查询会员任务状态](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-查询会员任务状态)
...
### [云小编 - 活动信息](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-活动信息)
...
### [云小编 - 获取任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-获取任务)
...
### [云小编 - 提交任务](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-提交任务)
...
### [云小编 - 领取任务积分](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-领取任务积分)
...
### [云小编 - 领取一日会员](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-领取一日会员)
...
### [云小编 - 剩余抽奖次数](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-剩余抽奖次数)
...
### [云小编 - 每日抽奖](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=云小编-每日抽奖)
...
### [发送/删除评论](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送删除评论-1)
...
### [获取在线设备列表](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=获取在线设备列表)
...
### [发送安全验证码](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=发送安全验证码)
...
### [强制下线设备](https://api-enhanced-nine-cyan.vercel.app/docs/#/?id=强制下线设备)
